(function() {
		...
		UI: {
			...
			createTabElement: function(id) {
				...
				$(`#tab_${id} .memo-tab-button-close`).on("click", () => {
					...
					UI.ConfirmationBox(_('1d7a209e5461c92be4a38e7cfef02380'), [{ 'text': _('70d9be9b139893aa6c69b5e77e614311'), 
  ...
  .							catch(error => {
			...
			enableScript: function(parent) {
				...
				// load css
				if (!$("link[href*='memo.css']")[0]) {
					$("head").append($(document.createElement("link")).load("/game.php?screen=memo link[href*='memo.css']"));
				};
